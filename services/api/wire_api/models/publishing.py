...
class Publication(Base, PKMixin, TimestampMixin):
    ...
    artifact_id: Mapped[uuid.UUID] = mapped_column(
        PGUUID(as_uuid=True), ForeignKey("artifact.id", ondelete="RESTRICT"), nullable=False
    )
    social_account_id: Mapped[uuid.UUID] = mapped_column(
        PGUUID(as_uuid=True), ForeignKey("social_account.id", ondelete="RESTRICT"), nullable=False
    )
    ...
    engagement: Mapped[dict[str, Any]] = mapped_column(JSONB, default=dict)
